...
if __name__ == "__main__":
    ...
    target_ports = [22, 80, 443, 8080, 3306, 3389, 445, 135, 139, 138, 137, 25, 53, 110, 143, 993, 995, 587, 465, 21, 20, 23, 69, 161, 162, 514, 520, 8000, 10000, 5000, 8081, 8443, 9000, 9090, 27017, 5432, 6379, 11211, 27015]
